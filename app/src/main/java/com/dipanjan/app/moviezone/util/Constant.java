...
public interface Constant {
   ...
   /*String[] HEADER_LIST = {MovieCategory.LATEST_MOVIES,
    ...
    interface MovieCategory {
        ...
        String MOVIE_SERIES = "movieseries";
    ...
    interface Header {
        String MOVIE_SERIES = "Explore Movie Series";
    ...
    interface SharedPreferenceTag{
        String HOST_LIST="host_list";
        String MOVIE_SERIES_JSON = "MOVIE_SERIES_JSON";
    }
    ...
    String FIREBASE_REMOTE_CONFIG_MOVIE_JSON = "MOVIE_JSON";
    String FIREBASE_REMOTE_CONFIG_HOST_LIST = "HOST_LIST";
